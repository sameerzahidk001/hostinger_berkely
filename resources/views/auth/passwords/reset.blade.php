                ...
                <div class="col-lg-6" style="background-color:white;">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="card2 card border-0 d-flex flex-column justify-content-center px-4 py-5" style="height: 100vh;">
                            ...
                            <small class="mb-3 font-weight-bold">{{ __('Reset Password') }}</small>
                            
                            <div class="row px-3 mb-3">
                                <label class="mb-1"><h6 class="mb-0 text-sm">{{ __('Email Address') }}</h6></label>
                            ...
                            <div class="row px-3 mb-3">
                                <label class="mb-1"><h6 class="mb-0 text-sm">{{ __('Confirm Password') }}</h6></label>
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                            
                            
                            <div class="row mb-3 px-3">
                                <button type="submit" class="btn btn-blue text-center">{{ __('Reset Password') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
