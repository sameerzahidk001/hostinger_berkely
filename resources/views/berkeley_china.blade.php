...
<section class="flex flex-col-reverse justify-between relative min-h-[491px] md:max-h-[491px]  bg-[#000435]">
    <div class="flex text-white  min-[1200px]:pl-[72px] md:pr-12 py-[30px] px-6  md:w-[50%] m-0  flex-1 flex-col ">
        ...
        <div class="items-center gap-1 hidden md:flex">
            ...
            <span class="font-bold">Berkeley China</span>
        ...
        <div class="flex flex-1 shrink-0 flex-col gap-4">
            <div class="flex gap-4 flex-1 items-start flex-col ">
                ...
                <div class="flex  flex-col">
                    <p class="text-[18px] font-medium ">Welcome to our Executive Education Centre in China, where we are
                        dedicated to empowering professionals with the knowledge, skills, and insights needed to excel
                        in today's rapidly evolving business landscape. Situated in the heart of one of the world's most
                        dynamic economic hubs, our center serves as a premier destination for executive development,
                        leadership training, and lifelong learning.
                    </p>
