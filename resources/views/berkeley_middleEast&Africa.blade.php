...
<section class="flex flex-col-reverse justify-between relative min-h-[491px] md:max-h-[491px]  bg-[#000435]">
    <div class="flex text-white  min-[1200px]:pl-[72px] md:pr-12 py-[30px] px-6  md:w-[50%] m-0  flex-1 flex-col ">
        ...
        <div class="items-center gap-1 hidden md:flex">
            ...
            <span class="font-bold">Berkeley Middle East & Africa</span>
    ...
    <div class="flex flex-col lg:flex-row items-center gap-x-24 gap-y-10">
        <div class="relative flex-1 gap-2 flex flex-col">
            ...
            <div class="flex flex-col">
                <p class="text-[18px] mt-6">The Executive Education Centre in the Middle East serves as a beacon of
                    excellence, offering tailored programs designed to meet the dynamic needs of professionals in the
                    region. With a focus on fostering leadership, innovation, and strategic thinking, our center
                    provides cutting-edge executive education initiatives that empower individuals and organizations to
        ...
        <div class="flex-1">
            <img src="{{ asset('frontend/images/webp/dubai-world-trade-centre.webp') }}" alt=""
