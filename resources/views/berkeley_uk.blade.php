...
<section class="card-hidden px-6 min-[1200px]:px-[72px] my-16 md:px-12">
    <div class="flex flex-col lg:flex-row-reverse items-center gap-x-24 gap-y-10">
        ...
        <div class="relative flex-1 flex flex-col gap-1">
            ...
            <div class="flex flex-col">
                <p class="text-[18px] font-medium text-primary my-6">Experience the vibrant academic atmosphere of
                    London at Berkeley Square as your study destination. Located in the heart of London, United Kingdom,
                    our institution offers a prestigious learning environment surrounded by cultural landmarks and
