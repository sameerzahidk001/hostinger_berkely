...
<section class="flex flex-col-reverse justify-between relative min-h-[491px] md:max-h-[491px]  bg-[#000435]">
    <div class="flex text-white  min-[1200px]:pl-[72px] md:pr-12 py-[30px] px-6  md:w-[50%] m-0  flex-1 flex-col ">
        ...
        <div class="flex flex-col gap-1 mt-4 md:mt-10 mb-4 md:mb-10">
            ...
            <h2 class="text-[42px] md:text-[48px] leading-[58px] font-canela text-white">Executive Education
...
<section class="flex flex-col text-black card-hidden">
    ...
    <div class="flex flex-col items-center bg-[#efefef] px-2 sm:px-4 py-10 md:px-10 lg:px-16 lg:py-10 gap-12">
        ...
        <div class=" gap-2  grid grid-cols-1 md:grid-cols-4">
            @foreach($categories as $index => $data) 
                <div class="bg-white p-8 self-start felx flex-col">
                    ...
                    <div class="tab w-full overflow-hidden border-b-2 border-dark">
                        ...
                        <label class="course-tab-label flex items-center justify-between text-[15px] font-ghothic font-semibold text-dark leading-normal cursor-pointer capitalize"
                            for="tab-single-{{$index}}">
                            <span>{{ $data->name }} programmes</span>
                            ...
                            <a href="{{ route('course.details', ['course' => $course->slug]) }}" target="_blank" class="flex group gap-2 items-center h">
                                <span
                                    class="text-[14px] font-ghothic group-hover:underline underline-offset-2 font-semibold leading-[20px] text-dark">{{ $course->title }}</span>
