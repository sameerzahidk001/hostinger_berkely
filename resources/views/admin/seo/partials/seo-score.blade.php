@php
    ...
    $allChecks = array_merge($analysis['basic'] ?? [], $analysis['additional'] ?? []);
@endphp
    ...
    <div class="ibox-content">
        <div class="row">
            <div class="col-md-4 text-center">
                ...
                <div class="text-muted" style="margin-top:8px;">SEO Rate</div>
                <div id="seo-score-label" class="label label-default" style="margin-top:8px;display:inline-block;">{{ $label }}</div>
            </div>
            <div class="col-md-8">
                <ul class="list-unstyled" id="seo-checklist" style="margin:0;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderAnalysis(data) {
        ...
        const checks = [].concat(data.basic || [], data.additional || []);
        document.getElementById('seo-checklist').innerHTML = checks.map(function (c) {
