...
@section('title', 'Create Course Agenda')
@push('style')
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins" style="margin-bottom: 0;">
                ...
                <div class="ibox-content">
                    ...
                    <form role="form" action="{{ route('admin.course-agendas.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-12" style="margin-bottom: 15px;">
                                <label for="to">Inquiry</label>
                                    <textarea name="inquiry" id="inquiry" rows="3" class="form-control">{{ old('inquiry') }}</textarea>
                                @error('inquiry')
                                    <p class="text-danger text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-lg-12 mb">
                                ...
                                <textarea name="description" class="form-control text-editor"
