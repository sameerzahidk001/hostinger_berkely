        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins" style="margin-bottom:0;">
                <div class="ibox-title">
                    <h5>Add Overview to Course Structure & Lecture Plan  </h5>
    ...
    <div class="wrapper wrapper-content">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="{{ route('course.add-course-part', ['id' => $course->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div id="courseStructureContainerStatic" class="mt-3">
                            <div class="courseStructureContainerStaticRow" style="margin-bottom: 16px;">
                                <div class="row">
                ...
                <div class="ibox-content">
                    <div class="courseStructureContainerRow" style="margin-bottom: 0px;">
                                        ...
                                        <div class="courseSubHeadingUnitContainer">
                                            ...
                                            <div class="row courseSubHeadingUnitRow">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <img src="{{ $subHeadingsUnit->thumbnail }}" style="width:40px; height: 35px;" alt="">
                        ...
                        <div class="row" style="margin-block: 16px;">
                            ...
                            <form action="{{ route('course.edit-course-structure-part') }}" method="POST" style="display:inline;">
                                @csrf
                                <input type="hidden" name="course_id" value="{{ $course->id }}">
                                <input type="hidden" name="part_id" value="{{ $courseStructure->id }}">
                                <button type="submit" class="btn btn-primary btn-sm UpdateCoursePart"><i class="fa fa-edit"></i> Update Part</button>
                            </form>
                            <a href="{{ route('course.del-course-structure', ['course_id' => $course->id, 'id' => $courseStructure->id]) }}" class="btn btn-danger btn-sm deleteCoursePart"><i class="fa fa-trash"></i> Remove Part</a>
                            </div>
                        </div>
                    </div>
                    <hr>
