                                ...
                                <div class="row courseSubHeadingRowStatic">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="courseSubHeadingUnitContainerStatic">
                                            @foreach($subHeading->subHeadingsUnits as $index2 => $subHeadingsUnit)
                                            <input type="hidden" name="course[subheading][{{ $index1 }}][unit][{{ $index2 }}][id]" value="{{ $subHeadingsUnit->id }}">
                                                <div class="row courseSubHeadingUnitRowStatic">
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        @endif
                                                        <input type="file" name="course[subheading][{{ $index1 }}][unit][{{ $index2 }}][thumbnail]" class="form-control" value="{{ $subHeadingsUnit->thumbnail }}">
                                                    </div>
                                                    <div class="col-lg-4">
